...
#remove exit without graduation from program status as it is duplicated under ProgramStatus and ExitTransfer
...
write.csv(genie6,"GeniePSNUxIM_OVC_20181119fix.csv", row.names = FALSE)
